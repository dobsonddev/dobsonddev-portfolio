...
function Resume() {
    ...
    return (
        <div ref={sectionRef} className="flex flex-col sm:min-h-screen items-center px-4">
            ...
            <div className="relative w-full flex justify-center py-6">
                ...
                <button
                    className={`flex flex-row ${isSticky ? 'fixed top-20 right-16 z-50' : 'hidden'} button-fade-in duration-300 `}>
                    <a
                        href={resumePDFPath}
                        download="Dobson_Dunavant_Resume.pdf"
                        className="bg-custom-orange text-white font-bold rounded text-lg md:text-xl px-4 py-2 flex items-center space-x-2"
