            ...
            >
                <div className="w-full max-w-7xl flex items-center justify-between px-8">
                    ...
                    <div className="hidden md:flex flex-1 items-center justify-end">
                        ...
                        <a href="#blog" className="hover:text-dark hover:bg-light px-4 pr-8 py-2 transition-all duration-500 transform hover:-translate-y-1 hover:animate-wiggle">Blog</a>
                        <div>
                            <ThemeSwitch />
                        </div>
                    </div>
